...
def orchestrator_node(state: AgentState) -> dict:
    ...
    prompt = (
        ...
        "operation number, tester name, or asks for live production data (test results, "
        "lot status, tester alarms, equipment logs). This agent fetches lot/unit XML "
        "data from the network share AND queries Lamas (Elasticsearch) for equipment "
        "alarms and logs. Include lot IDs, operations, time ranges, and tester IDs in sub_query.\n"
